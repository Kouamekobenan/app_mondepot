...
const CreateSaleButton: React.FC = () => (
  <Link href="/directeSale/create" className="group block h-full">
    <div
      className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl border-2
     border-dashed border-orange-300 p-6 h-full flex flex-col items-center justify-center
      hover:from-orange-100 hover:to-orange-200 hover:border-orange-400 transition-all duration-300 
      group-hover:shadow-lg min-h-[160px]"
    >
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-4 rounded-full mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
