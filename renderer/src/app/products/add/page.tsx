...
export default function Page(): React.ReactElement {
  ...
  useEffect(() => {
    ...
    initializeData();
  }, [isEditMode, productId, router, tenantId]);
              ...
              className={`
                ...
                ${
                  isSubmitting || loading
                    ...
                    : isEditMode
                    ? "bg-gradient-to-r fro-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white shadow-lg hover:shadow-xl"
